...
const Container = tw.div`relative ml--8 mr--10 mb-24 bg-steelblue-600 mt-16  `;
const Row = tw.div`flex flex-col p-32 lg:flex-row -mb-10`;
const Heading = tw(SectionHeading)` font-normal text-white text-left lg:text-4xl xl:text-5xl`;
...
const Title = tw.h5`mt-6 text-xl font-bold transition duration-300 group-hover:text-gray-900`;
const Description = tw.p`mt-2 font-medium text-gray-100 leading-loose text-sm`;
const AuthorInfo = tw.div`mt-6 flex items-center`;
const AuthorImage = tw.img`w-12 h-12 rounded-full`;
const AuthorNameAndProfession = tw.div`ml-4`;
const AuthorName = tw.h6`font-semibold text-lg`;
const AuthorProfile = tw.p`text-white text-sm`;
...
const RecentPostsContainer = styled.div`
  ...
  ${AuthorName} {
    ${tw`mt-3 text-sm text-white font-normal leading-none`}
  }
  ${Image} {
...
export default () => {
  ...
  const popularPosts = [
    {
      postImageSrc:
        "https://images.unsplash.com/photo-1593136878769-388e324638b3?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80",
      authorImageSrc:
    ...
    },
    {
      ...
      description:
        "Contemplating by the water feeds the soul. The expansive view of the ocean water, often referred to as blue space, actually calms our mind. If you've ever sat staring at an ocean and found that your problems seem to melt away as a sense of peace overcomes you, you're not alone. ",
  ...
  const recentPosts = [
    {
      ...
      title: "I've found my happy place",
      authorName: "Sam Wattson",
      url: "https://reddit.com",
    },
    {
      postImageSrc:
      ...
      title: "What's on my bucket list? Everywhere",
      authorName: "Philip Clark",
      url: "https://reddit.com",
    },
    {
      postImageSrc:
    ...
    },
    {
      ...
      title: "Only going places that spark joy.",
      authorName: "Sakura Miyako",
      url: "https://timerse.com",
    },
    {
      postImageSrc:
