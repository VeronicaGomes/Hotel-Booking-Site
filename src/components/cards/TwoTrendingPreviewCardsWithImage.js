...
const ThreeColumn = tw.div` flex flex-col items-center lg:items-stretch lg:flex-row flex-wrap lg:justify-center lg:-ml-10 pt-16 max-w-none w-full `;
const Column = tw.div``;
const HeadingColumn = tw(Column)`w-full `;

const HeadingInfoContainer = tw.div`text-center xl:text-left max-w-lg xl:max-w-none mx-auto xl:mx-0`;
const HeadingTitle = tw(SectionHeading)`font-normal xl:text-left xl:pl-20 `;
const HeadingDescription = tw.p`xl:w-3/4 xl:pl-20  text-sm md:text-base lg:text-lg font-medium leading-relaxed text-secondary-100 mt-8`;
const PrimaryLink = styled(PrimaryLinkBase)`
  ${tw`inline-flex justify-center xl:ml-224 text-steelblue-900 hover:text-steelblue-500 xl:justify-end sm:mt-6 items-center  text-lg`}
  svg {
    ${tw`ml-2 w-5 h-5 `}
  }
`;

const Card = tw.div`mx-auto xl:mx-0 xl:ml-auto max-w-sm md:max-w-xs lg:max-w-sm xl:max-w-xs sm:pb-16 `;
...
const CardType = tw.div`text-steelblue-900 font-medium text-lg`;
...
`;
const CardAction = tw(PrimaryButtonBase)`w-full mt-8 bg-steelblue-900 hover:bg-steelblue-500`;
      ...
      <Content>
        <HeadingColumn>
          <HeadingInfoContainer>
            <HeadingTitle>
              <em>Trending Tours</em>
            </HeadingTitle>
            <HeadingDescription>
              From relaxing in the Bahamas to cruising on Mariana Trench, we provide all kind of services to the tourist .
            </HeadingDescription>
            <PrimaryLink>
